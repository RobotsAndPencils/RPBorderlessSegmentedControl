Pod::Spec.new do |s|
  ...
  s.homepage         = "https://www.github.com/interestateone/RPBorderlessSegmentedControl"
  ...
  s.source           = { :git => "https://github.com/interstateone/RPBorderlessSegmentedControl.git", :tag => s.version.to_s }
